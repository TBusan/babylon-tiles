/**
 * @description: Linear projection of latitude and longitude (EPSG:4326)
...
/**
 * Linear projection of latitude and longitude (WGS84, EPSG:4326)
 */
export class ProjWGS extends Projection implements IProjection {
  public readonly ID = "4326";
  public mapWidth = 36000 * 1000; // E-W scale (*0.01°)
